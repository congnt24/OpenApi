# Awesome API OpenAPI Specification
[![Build Status](https://travis-ci.org/congnt24/OpenApi.svg?branch=master)](https://travis-ci.org/congnt24/OpenApi)
...
6. If you did everything correct, https://congnt24.github.io/OpenApi/ will lead to your new docs
...
- Documentation(ReDoc): https://congnt24.github.io/OpenApi/
- SwaggerUI: https://congnt24.github.io/OpenApi/swagger-ui/
- Look full spec:
    + JSON https://congnt24.github.io/OpenApi/swagger.json
    + YAML https://congnt24.github.io/OpenApi/swagger.yaml
- Preview spec version for branch `[branch]`: https://congnt24.github.io/OpenApi/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://congnt24.github.io/OpenApi/ with url from the message: `Server started <url>`
